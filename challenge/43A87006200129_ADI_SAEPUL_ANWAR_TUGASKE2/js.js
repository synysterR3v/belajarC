...
function validasi() {
    ...
    // if (jns_barang.value == "food") {
    //     print("Makanan")
    // } else if(jns_barang.value == "drink"){
    //     print("Minuman")
    // } else if(jns_barang.value == "home-tool"){
    //     print("Peralatan Rumah Tangga")
    // } else if (jns_barang.value == "wash"){
    //     print("Peralatan Mencuci")
    // }
    // else {
    //     return false
    // }
