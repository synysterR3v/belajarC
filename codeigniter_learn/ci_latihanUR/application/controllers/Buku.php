<?php
	...
	class Buku extends CI_Controller {
		...
		function tambah_buku(){
			$rs['data_buku'] = array();
			$this->load->view('master/buku/tambah_buku', $rs);
		}
		...
		function ubah_data($id){
			$rs['data_buku'] = $this->Buku_Model->showDataById($id)->result();
		...
		function perbarui_data(){
			...
			$this->Buku_Model->updateData($idbuku,$dataBuku);
